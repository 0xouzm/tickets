...
# 清理临时文件，如验证码等
from conf_example import g_passengers, g_max_auto_times, passwd, g_buy_list, g_ingnore_list, \
...
def show_ticket(self, it):
    print(it['station_train_code'], it['from_station_name'], it['to_station_name'], it['start_time'], it['arrive_time'],
          it['lishi'], \
          it['swz_num'], it['tz_num'], it['zy_num'], it['ze_num'], it['gr_num'], it['rw_num'], it['yw_num'],
          it['rz_num'], it['wz_num'], it['canWebBuy'])
